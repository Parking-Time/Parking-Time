...
const BorderRadius kAllRound0 = BorderRadius.all(Radius.zero);
const BorderRadius kAllRound5 = BorderRadius.all(Radius.circular(5));
const BorderRadius kAllRound7 = BorderRadius.all(Radius.circular(7));
...
const BorderRadius kTopRound5 = BorderRadius.vertical(top: Radius.circular(5));
const BorderRadius kTopRound7 = BorderRadius.vertical(top: Radius.circular(7));
...
const BorderRadius kBottomRound5 = BorderRadius.vertical(bottom: Radius.circular(5));
const BorderRadius kBottomRound7 = BorderRadius.vertical(bottom: Radius.circular(7));
...
const BorderRadius kLeftRound5 = BorderRadius.horizontal(left: Radius.circular(5));
const BorderRadius kLeftRound7 = BorderRadius.horizontal(left: Radius.circular(7));
...
const BorderRadius kRightRound5 = BorderRadius.horizontal(right: Radius.circular(5));
const BorderRadius kRightRound7 = BorderRadius.horizontal(right: Radius.circular(7));
